                                ...
                                <div class="container px-5 py-8 mx-auto">
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="is_selling" class="leading-7 text-sm text-gray-600">is_selling</label>
                                                    <input
                                                        type="radio" id="is_selling" name="is_selling"
                                                    ...
                                                    <input
                                                        ...
                                                        v-model="form.is_selling"
                                                        value="0">
                                                    <label for="is_selling">停止中</label>
                                                </div>
                                                <div v-if="errors.price">{{ errors.price }}</div>
                                            </div>
                                            <div class="p-2 w-full">
